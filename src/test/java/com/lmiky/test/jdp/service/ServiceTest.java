...
public class ServiceTest extends BaseTest {
    ...
    public void testFind4() throws ServiceException {
        Goods goods = baseService.find(Goods.class, new PropertyFilter("title", "商品信息2", PropertyCompareType.EQ,
                Goods.class), new PropertyFilter("marketPrice", 1.0, PropertyCompareType.EQ, Goods.class),
                new PropertyFilter("couponDiscount", 0.5, PropertyCompareType.LE, Goods.class));
        System.out.println(goods.getTitle());
    }
    ...
    public void testDelete4() throws ServiceException {
        System.out.println(baseService.delete(Goods.class, new PropertyFilter("id", 733l, PropertyCompareType.EQ,
                Goods.class)));
    }
    ...
    public void testList9() throws ServiceException {
        System.out.println(baseService.list(Goods.class,
                new PropertyFilter("title", null, PropertyCompareType.NNULL, Goods.class)).size());
    }

    @Test
    public void testList10() throws ServiceException {
        System.out.println(baseService.list(Goods.class, new Sort("id", Sort.SORT_TYPE_ASC, Goods.class),
                new Sort("title", Sort.SORT_TYPE_DESC, Goods.class)).size());
    }

    @Test
    public void testList11() throws ServiceException {
        System.out.println(baseService.list(Module.class, 1, 10,
                new PropertyFilter("group.id", 1l, PropertyCompareType.EQ, Module.class)).size());
    }

    @Test
    public void testList12() throws ServiceException {
        System.out.println(baseService.list(Goods.class, 1, 10, new Sort("id", Sort.SORT_TYPE_ASC, Goods.class),
                new Sort("title", Sort.SORT_TYPE_DESC, Goods.class)).size());
    }
    ...
    public void testCount4() throws ServiceException {
        System.out.println(baseService.count(Goods.class, new PropertyFilter("id", 4l, PropertyCompareType.GE,
                Goods.class)));
    }
    ...
    public void testExist3() throws ServiceException {
        System.out.println(baseService.exist(Goods.class, new PropertyFilter("id", 4l, PropertyCompareType.GE,
                Goods.class)));
    }
