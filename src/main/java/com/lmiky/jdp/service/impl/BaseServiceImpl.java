...
public class BaseServiceImpl implements BaseService {
    ...
    public <T extends BasePojo> boolean update(Class<T> pojoClass, Map<String, Object> condition,
            Map<String, Object> updateValue) throws ServiceException {
        try {
    ...
    public <T extends BasePojo> boolean update(Class<T> pojoClass, String conditionFieldName,
            Object conditionFieldValue, String updateFieldName, Object updateFieldValue) throws ServiceException {
        try {
            return getDAO().update(pojoClass, conditionFieldName, conditionFieldValue, updateFieldName,
                    updateFieldValue);
        } catch (DatabaseException e) {
            throw new ServiceException(e.getMessage());
        }
    ...
    public <T extends BasePojo> List<T> list(Class<T> pojoClass, List<PropertyFilter> propertyFilters,
            List<Sort> sorts, int pageFirst, int pageSize) throws ServiceException {
        try {
    ...
    public <T extends BasePojo> List<T> list(Class<T> pojoClass, int pageFirst, int pageSize,
            PropertyFilter... propertyFilters) throws ServiceException {
        try {
