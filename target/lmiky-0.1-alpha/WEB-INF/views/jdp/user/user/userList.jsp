										...
										<tr>
											<lauthority:checkAuthority authorityCode="jdp_user_user_add" modulePath="jdp/user/user">
												<td align="center">
													<table>
														<tr>
															<td align="center" class="btn_menu btnClass_td" onClick="openDialog('<c:url value="/user/load.shtml?${httpParamOpenMode }=${createOpenMode }&modulePath=${modulePath }"/>', 800, 600)">添加</td>
														</tr>
													</table>
												</td>
											...
											<td align="center">
												<table>
													<tr>
														...
														<favorite:inMyMenu menuId="jdp_user_user_load">
															<c:set var="isFavorited" value="${true}" />
															<td align="center" class="btn_menu btnClass_td" onClick="removeMyFavoriteMenu('jdp_user_user_load', this)">取消收藏</td>
														</favorite:inMyMenu>
														<c:if test="${!isFavorited }">
															<td align="center" class="btn_menu btnClass_td" onClick="addMyFavoriteMenu('jdp_user_user_load', this)">添加到收藏夹</td>
														</c:if>
													</tr>
												</table>
											</td>
